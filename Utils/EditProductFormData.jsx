...
import { SetProductData } from "@/app/redux/slices/NewProductSlice";
import { AddNotifyMessage } from "@/app/redux/slices/NotifyMessageSlice";

const useEditProductFormData = () => {
    const ProductDetails = useSelector(state => state.NewProductData);
