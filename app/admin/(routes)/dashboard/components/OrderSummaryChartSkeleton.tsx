...
export function OrderSummaryChartSkeleton() {
    return (
        <div className='w-full ring-1 shadow-md bg-white ring-gray-200 rounded-md px-5 py-5 gap-2 sm:gap-6 flex flex-col lg:flex-9 animate-pulse'>
            {/* Header Section */}
            ...
            {/* Chart Skeleton */}
            <div className=' h-[250px] md:h-[300px] lg:h-[360px] flex items-end justify-between gap-2 w-full overflow-hidden'>
