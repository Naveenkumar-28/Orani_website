    ...
    return (
        <div className="flex justify-between items-center">
            ...
            <div id="Review_product_btn" className="flex gap-2">
                ...
                <button disabled={isLoading} onClick={() => onClickThrottled({ name, action: 'back' })} className="bg-green active:scale-95 shadow-sm active:shadow-none focus-within:outline-none text-white cursor-pointer sm:text-lg text-base rounded-sm px-2 py-2">
