...
export const sendOrderCancelledEmail = async (data: EmailData) => {
    ...
    const templatePath = path.join(process.cwd(), "templates", "orderCancelled", "orderCancelled.ejs");
    ...
    await sendMail(data.to, `Order #${data.orderId} Cancelled successfully`, html)
